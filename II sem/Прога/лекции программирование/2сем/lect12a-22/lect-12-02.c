...
/* ------------------------------------ */
void SortKind(int n, studs **str0, void (*funcName)(studs**, int));
...
void SortYear(studs **str0, int n0)
{
    ...
    {
        tmp_struct=str0[i];
        for(j=i-1;(j>=0)&&((str0[j]->year_of_birth)>(tmp_struct->year_of_birth));j--)
            str0[j+1]=str0[j];
        str0[j+1]=tmp_struct;
     }
}
...
void SortCourse(studs **str0, int n0)
{
    ...
    {
        tmp_struct=str0[i];
        for(j=i-1;(j>=0)&&((str0[j]->year)>(tmp_struct->year));j--)
            str0[j+1]=str0[j];
        str0[j+1]=tmp_struct;
     }
}
